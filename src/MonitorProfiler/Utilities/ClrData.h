...
//IMPORTANT All data, including simple primitives must be returned by reference. We serialize the data using event source, which uses addresses even for primitive values.
...
enum class ClassFlags : unsigned int
{
    None = 0,
    Array,
    Composite,
