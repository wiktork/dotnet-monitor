        ...
        IValidatableObject
    {
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            else if (hasProviders)
            {
                ...
                {
                    results.AddRange(e.Failures.Select((string failure) => new ValidationResult(
                        string.Format(CultureInfo.CurrentCulture, Strings.ErrorMessage_NestedValidationError, nameof(GlobalCounterOptions), e.Message))));
                }
